...
from kbkit.plotter.thermo import ThermoPlotter
...
class KBThermo:
    ...
    def temperature(self, units: str = "K") -> np.ndarray:
        ...
        return self.systems.properties.simulated_property(name="Temperature", units=units).value
    ...
    def rho(self, units: str = "molecule/nm^3") -> np.ndarray:
        ...
        return self.systems.properties.simulated_property(name="number_density", units=units).value

    def v_bar(self, units: str = "cm^3/mol") -> np.ndarray:
        """np.ndarray: 1D array of ideal molar volumes of each system."""
        return self.systems.properties.ideal_property(name="molar_volume", units=units).value

    @property
    def z_i(self) -> np.ndarray:
        """np.ndarray: Electrons present in the system mapped to ``molecules``."""
        return self.systems.properties.pure_property(name="electron_count").value

    @property
    def z_bar(self) -> np.ndarray:
        """np.ndarray: Ideal electron contribution for each system."""
        return self.systems.properties.ideal_property(name="electron_count").value
    ...
    def h_mix(self, units: str = "kJ/mol") -> np.ndarray:
        ...
        """
        return self.systems.properties.excess_property(name="enthalpy", units=units).value
