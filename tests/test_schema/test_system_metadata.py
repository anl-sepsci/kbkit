...
class TestSystemMetadataInitialization:
    ...
    def test_basic_initialization(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="water", kind="pure", path=tmp_path, props=mock_system_properties)
    ...
    def test_initialization_with_rdf_path(self, mock_system_properties, tmp_path, temp_rdf_directory):
        ...
        system = SystemMetadata(
            name="ethanol", kind="pure", path=tmp_path, props=mock_system_properties, rdf_path=temp_rdf_directory
        )
    ...
    def test_default_rdf_path(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="mixture", kind="mixture", path=tmp_path, props=mock_system_properties)
    ...
    def test_path_conversion(self, mock_system_properties):
        ...
        system = SystemMetadata(
            name="test", kind="pure", path=Path("/tmp/test"), props=mock_system_properties, rdf_path=Path("/tmp/rdf")
        )
...
class TestHasRdfMethod:
    ...
    def test_has_rdf_with_xvg_files(self, mock_system_properties, tmp_path, temp_rdf_directory):
        ...
        system = SystemMetadata(
            name="test", kind="pure", path=tmp_path, props=mock_system_properties, rdf_path=temp_rdf_directory
        )
    ...
    def test_has_rdf_empty_directory(self, mock_system_properties, tmp_path, empty_rdf_directory):
        ...
        system = SystemMetadata(
            name="test", kind="pure", path=tmp_path, props=mock_system_properties, rdf_path=empty_rdf_directory
        )
    ...
    def test_has_rdf_default_path(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="test", kind="pure", path=tmp_path, props=mock_system_properties)
    ...
    def test_has_rdf_nonexistent_directory(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(
            name="test", kind="pure", path=tmp_path, props=mock_system_properties, rdf_path=nonexistent_path
        )
...
class TestIsPureMethod:
    ...
    def test_is_not_pure_mixture(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="water_ethanol", kind="mixture", path=tmp_path, props=mock_system_properties)
    ...
    def test_is_not_pure_other(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="test", kind="binary", path=tmp_path, props=mock_system_properties)

        assert system.is_pure() is False

    def test_is_not_pure_empty_string(self, mock_system_properties, tmp_path):
        """Test is_pure returns False for empty string kind."""
        system = SystemMetadata(name="test", kind="", path=tmp_path, props=mock_system_properties)
...
class TestSystemMetadataEdgeCases:
    ...
    def test_system_with_special_characters_in_name(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="H2O-EtOH_mix@298K", kind="mixture", path=tmp_path, props=mock_system_properties)
    ...
    def test_system_with_unicode_name(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="système_α", kind="pure", path=tmp_path, props=mock_system_properties)
    ...
    def test_dataclass_equality(self, mock_system_properties, tmp_path):
        ...
        system1 = SystemMetadata(name="water", kind="pure", path=tmp_path, props=mock_system_properties)
        system2 = SystemMetadata(name="water", kind="pure", path=tmp_path, props=mock_system_properties)
    ...
    def test_dataclass_inequality(self, mock_system_properties, tmp_path):
        ...
        system1 = SystemMetadata(name="water", kind="pure", path=tmp_path, props=mock_system_properties)
        system2 = SystemMetadata(name="ethanol", kind="pure", path=tmp_path, props=mock_system_properties)
...
class TestSystemMetadataIntegration:
    ...
    def test_complete_workflow_pure_system(self, mock_system_properties, tmp_path, temp_rdf_directory):
        ...
        system = SystemMetadata(
            name="argon", kind="pure", path=tmp_path, props=mock_system_properties, rdf_path=temp_rdf_directory
        )
    ...
    def test_complete_workflow_mixture_system(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="water_methanol", kind="mixture", path=tmp_path, props=mock_system_properties)
    ...
    def test_path_operations(self, mock_system_properties, tmp_path):
        ...
        system = SystemMetadata(name="test", kind="pure", path=system_dir, props=mock_system_properties)
