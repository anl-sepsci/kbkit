...
class TestFromCollectionClassMethod:
    ...
    def test_from_collection_with_string_name(self, mock_system_collection, mock_mplstyle):
        ...
        plotter = TimeseriesPlotter.from_collection(mock_system_collection, "water", start_time=1000)
    ...
    def test_from_collection_with_int_index(self, mock_system_collection, mock_mplstyle):
        ...
        plotter = TimeseriesPlotter.from_collection(mock_system_collection, 0, start_time=2000)
    ...
    def test_from_collection_default_start_time(self, mock_system_collection, mock_mplstyle):
        ...
        plotter = TimeseriesPlotter.from_collection(mock_system_collection, "water")
    ...
    def test_from_collection_accesses_correct_system(self, mock_system_collection, mock_mplstyle):
        ...
        plotter = TimeseriesPlotter.from_collection(mock_system_collection, "test_system")
...
class TestPlotMethod:
    ...
    def test_plot_basic(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_resolves_property_name(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_with_custom_units(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_with_running_average(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_without_running_average(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
    ...
    def test_plot_with_custom_labels(
        ...
        plotter = TimeseriesPlotter(mock_system_properties)
        plotter.plot("potential", xlabel="Custom X", ylabel="Custom Y", title="Custom Title", show=False)
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_with_axis_limits(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
        ...
        plotter = TimeseriesPlotter(mock_system_properties)
        plotter.plot("potential", xlim=(0, 10), ylim=(-1100, -900), show=False)
    ...
    def test_plot_with_custom_style(
        ...
        plotter = TimeseriesPlotter(mock_system_properties)
        plotter.plot("potential", color="red", show_avg=False, alpha=0.5, ls="--", lw=2, marker="o", show=False)
    ...
    def test_plot_save_to_file(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, tmp_path, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_save_to_directory(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, tmp_path, mock_mplstyle
    ):
    ...
    def test_plot_formats_units(
        self, mock_format, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, mock_mplstyle
    ):
...
class TestRunningAverage:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_running_average_label_format_small(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_mplstyle
    ):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_running_average_label_format_large(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_mplstyle
    ):
...
class TestIntegration:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_from_collection_to_plot(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_collection, mock_mplstyle
    ):
        ...
        plotter = TimeseriesPlotter.from_collection(mock_system_collection, "water", start_time=2000)
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_with_all_options(
        self, mock_close, mock_show, mock_subplots, mock_resolve, mock_system_properties, tmp_path, mock_mplstyle
    ):
